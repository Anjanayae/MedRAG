...
# matches = [
#     c for c in chunks
#     if c['focus'] == 'Hypoglycemia' and c['source'] == 'NIDDK'
# ]
...
a = [c for c in chunks if c["chunk_id"].startswith("0012708::")]
b = [c for c in chunks if c["chunk_id"].startswith("0012709::")]

for x, y in zip(a, b):
    print(x["chunk_id"], "==", y["chunk_id"], ":", x["chunk_text"] == y["chunk_text"])